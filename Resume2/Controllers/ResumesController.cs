  ...
  public class ResumesController : Controller
    {
        ...
        public ResumesController(Resume2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ResumeID,FirstLast,City,State,Email,Phone,Summary")] Resume resume)
        {
